/**
 * Định nghĩa riêng một Class ApiError kế thừa class Error sẵn có của NodeJS/JS (điều này cần thiết và là Best Practice vì class Error nó là class built-in sẵn)
 */
class ApiError extends Error { //extend Error của NodeJS/JS
